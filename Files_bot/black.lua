...
send(msg.chat_id,msg.id,"⌔ مرحببا بك عزيزي في مصنع الحمايه المجاني لسورس الماس \n⌔ مبرمج السورس @BK_ZT","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
local TestText = "𓆩⸤Տᗩᒪᗩᕼ⸥𓆪𖣩ًََِْٰٓ ⃝⃙‌🇧🇴ᗴ7Tᒪᗩᒪ𓆪⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ\n— — — — — — — — —\n ❍*َdev name➢* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n❍*َbio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '𓆩⸤Տᗩᒪᗩᕼ⸥𓆪𖣩ًََِْٰٓ ⃝⃙‌🇧🇴ᗴ7Tᒪᗩᒪ𓆪⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ', url = "https://t.me/BK_ZT"}
},
}
...
photo = "https://t.me/photobotSalah/2"
local T =[[
