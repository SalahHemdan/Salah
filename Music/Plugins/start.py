...
def start_pannel():
    buttons = [
        ...
        [
            InlineKeyboardButton("⌔ الاوامـــــر", url="https://t.me/CR_T2/804"),
        ],
        [
            InlineKeyboardButton("⁨Dٍiٰaِmٓoِٰ𝗇ٰDِ SoٰuِRٰcٌe⁩", url="https://t.me/CR_T2"),
        ],
    ]
    return (
        "⌔ **{BOT_NAME} اهلا انا بوت تشغيل موسيقي في المحدثات الصواتية للاستماع بالموسيقي🍿**",
        buttons,
    )
        ...
        try:
            ...
            if member.id == BOT_ID:
                ...
                await message.reply_text(
                    f"""
⌔ ↯ ** مرحبـا عزيـزي سأبـذل قصار جهـدي لأسمـعكـم موسـيقي عالـية الجـودة**
...
⌔ **مـتـوسـط تـقـيـم:** {x["average_rating"]}
⌔ **اسـم الـقـناة:** {x["uploader"]}
⌔ **رابـط الـقـنـاة:** [Kunjungi Dari Sini]({x["channel_url"]})
